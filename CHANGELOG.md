...
### Security
- Keep temp files of running jobs out of the hourly cleanup (#118)
- deps: bump js-yaml from 4.3.1 to 4.3.2
- ci: stop security patches from stranding on main (#117)
- deps: bump the npm group across 1 directory with 11 updates (#114)
...
### Security
- deps: bump apprise from 1.13.0 to 1.13.1 in the pip group (#113)
...
### Security
- deps: bump the npm group with 12 updates (#112)
- deps: update msgpack requirement from >=1.2.1 to >=1.2.2 (#111)
...
### Security
- deps: bump the npm group with 7 updates (#110)
- deps: bump apprise from 1.12.0 to 1.13.0 in the pip group (#108)
- ci: bump docker/setup-buildx-action in the actions group (#109)
...
- Approved videos on the admin project page show the share-page style checkmark badge on the thumbnail corner instead of a text label (hover shows the approved version count).
