...
export default function AnnotationToolbar({
  ...
  return (
    <div className="absolute top-3 left-1/2 -translate-x-1/2 z-30 flex items-center gap-1.5 bg-black/85 backdrop-blur-sm rounded-xl px-3 py-2 shadow-2xl border border-white/10">
      {/* Tool indicator */}
      ...
      {ANNOTATION_COLORS.map((color) => (
        <button
          ...
          className={`w-6 h-6 rounded-full transition-transform ring-2 ring-inset ${
      ...
      <div className="flex items-center gap-0.5" title="Stroke thickness">
        ...
        <div className="w-6 flex items-center justify-center" title={`Thickness ${currentStepIndex + 1}/${STROKE_STEPS.length}`}>
          <div
